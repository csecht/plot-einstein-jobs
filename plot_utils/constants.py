...
PROJECTS = ('all', 'fgrp5', 'fgrpBG1', 'gw_O2', 'gw_O3', 'gw_O4', 'brp4', 'brp7',)

CHKBOX_LABELS = ('all', 'fgrp5', 'fgrpBG1', 'fgrp_hz', 'gw_O2', 'gw_O3', 'gw_O4',
                 'brp4', 'brp7', 'fgrpHz_X_t', 'gwO3Hz_X_t', 'gwO4Hz_X_t',)

EXCLUSIVE_PLOTS = ('all', 'fgrp_hz', 'fgrpHz_X_t', 'gwO3Hz_X_t', 'gwO4Hz_X_t',)

ALL_INCLUSIVE = ('fgrp5', 'fgrpBG1', 'gw_O2', 'gw_O3', 'gw_O4', 'brp4', 'brp7',)
...
# Dict used in PlotTasks.manage_plots() to match checkbox CHKBOX_LABELS to
